 ...
 * [io.github.eregruser.blindfoldchess.voice.VoiceCommandParser]) plus the move-utterance shape
 * enforced by [io.github.eregruser.blindfoldchess.voice.ChessGrammar]. Hand-curated; if you add a new
